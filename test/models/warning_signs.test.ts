  ...
  describe('parsing signs', () => {
    it('works', () => {
      const warning_signs = WARNING_SIGNS.map((sign) => {
        const expression = parseFindingExpression(sign.clinical_finding_s_expression)
        return {
          ...sign,
          expression,
        }
      ...
      assertEquals(warning_signs, [
        {
          ...
          'clinical_finding_s_expression': '(finding 79688008)',
        ...
        {
          'key': 'Seizure',
          'clinical_finding_s_expression': '(finding 91175000 (qualifier 15240007))',
        ...
        {
          'key': 'Burn Facial',
          'clinical_finding_s_expression': '(finding 262582004)',
        ...
        {
          'key': 'Burn Inhalation',
          'clinical_finding_s_expression': '(finding 425082000)',
          'sats_primary_name': 'Burn',
        ...
        {
          'key': 'Cardiac arrest',
          'clinical_finding_s_expression': '(finding 410429000)',
        ...
        },
        {
          ...
          'clinical_finding_s_expression': '(finding 400209005)',
        ...
        },
        {
          ...
          'clinical_finding_s_expression': '(finding 230690007)',
        ...
        {
          'key': 'Fracture',
          'clinical_finding_s_expression': '(finding 706886007)',
        ...
        },
        {
          ...
          'clinical_finding_s_expression': '(finding 125666000 (qualifier 255593009))',
          'sats_primary_name': 'Burn',
        ...
        },
        {
          ...
          'clinical_finding_s_expression': '(finding 267036007 (qualifier 24484000))',
        ...
        {
          'key': 'Aggression',
          'clinical_finding_s_expression': '(finding 61372001)',
        ...
        {
          'key': 'Burn Chemical',
          'clinical_finding_s_expression': '(finding 426284001)',
          'sats_primary_name': 'Burn',
        ...
        {
          'key': 'Threatened limb',
          'clinical_finding_s_expression': '(finding 21631000119105)',
        ...
        {
          'key': 'Poisoning',
          'clinical_finding_s_expression': '(finding 75478009)',
        ...
        {
          'key': 'Overdose',
          'clinical_finding_s_expression': '(finding 1149222004)',
        ...
        {
          'key': 'Coughing blood',
          'clinical_finding_s_expression': '(finding 66857006)',
        ...
        {
          'key': 'Eye injury',
          'clinical_finding_s_expression': '(finding 231794000)',
        ...
        {
          'key': 'Chest pain',
          'clinical_finding_s_expression': '(finding 29857009)',
        ...
        },
        {
          ...
          'clinical_finding_s_expression': '(finding 267051003)',
        ...
        {
          'key': 'Stabbed neck',
          'clinical_finding_s_expression': '(finding 283457003)',
        ...
        },
        {
          ...
          'clinical_finding_s_expression': '(finding 52329006)',
        ...
        },
        {
          ...
          'clinical_finding_s_expression': '(finding 21522001)',
        ...
        },
        {
          ...
          'clinical_finding_s_expression': '(finding 131148009 (qualifier 19032002))',
        ...
        },
        {
          ...
          'clinical_finding_s_expression': '(finding 31758001)',
        ...
        {
          'key': 'Severe pain',
          'clinical_finding_s_expression': '(finding 76948002)',
        ...
        },
        {
          ...
          'clinical_finding_s_expression': '(finding 284549007 (qualifier 6736007))',
          'sats_primary_name': 'Burn',
        ...
        },
        {
          ...
          'clinical_finding_s_expression': '(finding 131148009 (qualifier 31509003))',
        ...
        },
        {
          ...
          'clinical_finding_s_expression': '(finding 827108008)',
        ...
        },
        {
          ...
          'clinical_finding_s_expression': '(finding 263030002)',
        ...
        {
          'key': 'Fracture',
          'clinical_finding_s_expression': '(finding 423125000)',
          'sats_primary_name': 'Fracture',
          'sats_secondary_text': 'Closed (no break in the skin)',
          'sats_priority_snomed_concept_id': '103391001',
          'expression': {
        ...
        {
          'key': 'Burn Other',
          'clinical_finding_s_expression': '(finding 125666000)',
          'sats_primary_name': 'Burn',
        ...
        },
        {
          ...
          'clinical_finding_s_expression': '(finding 196746003)',
        ...
        {
          'key': 'Moderate pain',
          'clinical_finding_s_expression': '(finding 50415004)',
