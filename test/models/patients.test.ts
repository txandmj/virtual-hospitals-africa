          ...
          sortBy([
            {
              ...
              names: {
                full: test_patient1.name!,
                first: test_patient1.first_names!,
                surname: test_patient1.surname!,
                preferred: test_patient1.preferred_name!,
              },
            ...
            },
            {
              ...
              names: {
                full: test_patient2.name!,
                first: test_patient2.first_names!,
                surname: test_patient2.surname!,
                preferred: test_patient2.preferred_name!,
              },
              dob_formatted: '1 January 1980',
              date_of_birth: '1980-01-01',
              address: null,
