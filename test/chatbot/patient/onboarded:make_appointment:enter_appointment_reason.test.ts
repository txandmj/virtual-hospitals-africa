...
describe('patient chatbot', () => {
  ...
  it('asks for reason after inquiring national ID number', async () => {
    await patients.upsert(db, {
      conversation_state: 'onboarded:make_appointment:enter_appointment_reason',
    ...
    assertEquals(fakeWhatsApp.sendMessages.firstCall.args, [
      {
        messages: {
            messageBody: "Got it, 00000000. What is the reason you want to schedule an appointment?",
            type: "string"
          },
        phone_number: '00000000',
      },
