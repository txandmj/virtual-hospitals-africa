...
// describe.skip('/app/patients/[patient_id]/intake', {
...
//     assert(
//       response.url === `${route}/app/patients/${patient_id}/intake`,
//     )
...
//       `${route}/app/patients/${patient_id}/intake`,
//       {
//         method: 'POST',
//         body,
//       },
...
//     assertEquals(
//       getResponse.url,
//       `${route}/app/patients/${patient_id}/intake?warning=Some%20questions%20are%20age-dependent%2C%20so%20please%20fill%20out%20the%20patient%27s%20personal%20information%20beforehand.`,
//     )
//   })
