...
// import { family } from '../../../db/models/family.ts'
...
// import { patient_occupations } from '../../../db/models/patient_occupations.ts'
// import { patient_lifestyle } from '../../../db/models/patient_lifestyle.ts'
//

// describe.skip('/app/patients/[patient_id]/registration', {
...
//     const prior_registration_steps = INTAKE_STEPS
//     const patient_registration_insert = prior_registration_steps.map((registration_step) => ({
//       patient_id,
//       registration_step,
//     }))

//     await db.insertInto('patient_registration').values(patient_registration_insert)
//       .execute()
...
//     await db.insertInto('patient_registration').values({
//       patient_id,
