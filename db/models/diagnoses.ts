...
//       sql = sql.where(
//         'diagnoses.patient_encounter_id',
//         '=',
//         patient_encounter_id,
//       )
//     }
...
//       self,
//       others,
//       approved_by_self: self.concat(
//         others.filter((d) => d.approval === 'agree'),
//       ),
//     }
//   },
...
//     },
//   ): Promise<void> {
//     const existing_diagnoses = await diagnoses.getFromReview(trx, {
//       review_id,
//       employment_id,
//       patient_encounter_id,
//     })
...
//           const matching_diagnoses_collaboration = existing_diagnoses.others
//             .find(
//               (existing_diagnoses_collaboration) =>
//                 existing_diagnoses_collaboration.diagnosis_id ===
//                   d.diagnosis_id,
