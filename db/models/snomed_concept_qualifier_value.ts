...
function baseQuery(trx: TrxOrDbOrQueryCreator, terms: SearchTerms) {
  ...
  return trx
    .selectFrom('snomed_concept_qualifier_value')
    .innerJoin(
      'snomed_inferred_canonical_name_and_category',
      'snomed_inferred_canonical_name_and_category.id',
      'snomed_concept_qualifier_value.id',
    )
    ...
    .$if(!!terms.descendant_of_snomed_concept_id, (qb) =>
      qb.innerJoin(
        ...
        (join) =>
          join
            .onRef('ancestor_filter.descendant_id', '=', 'snomed_concept_qualifier_value.id')
    ...
    .$if(!!terms.descendant_of_snomed_concept_name, (qb) => {
      ...
      return qb
        ...
        .innerJoin(
          ...
          (join) =>
            join
              .onRef('named_ancestor_filter.descendant_id', '=', 'snomed_concept_qualifier_value.id')
...
export const snomed_concept_qualifier_value = base({
  top_level_table: 'snomed_concept_qualifier_value',
  baseQuery,
