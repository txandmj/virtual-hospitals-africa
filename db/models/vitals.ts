...
export async function computeAndInsertDerivedMeasurements(
  ...
  if (
    height_measurement && weight_measurement &&
    height_measurement.value && weight_measurement.value &&
    height_measurement.value > 0 && weight_measurement.value > 0
  ) {
  ...
  if (
    systolic_measurement && diastolic_measurement &&
    systolic_measurement.value && diastolic_measurement.value &&
    systolic_measurement.value > 0 && diastolic_measurement.value > 0
  ) {
