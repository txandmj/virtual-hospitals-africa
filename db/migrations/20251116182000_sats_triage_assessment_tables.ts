...
export async function up(db: Kysely<unknown>) {
  ...
  await db.schema
    ...
    .addColumn("assessment_snomed_id", "bigint", (col) =>
      col.notNull().references("sats_triage_assessments.assessment_snomed_id")
        .onDelete("cascade")
    )
    .addColumn("option_snomed_concept_id", "bigint", (col) =>
      col.notNull()
    )
