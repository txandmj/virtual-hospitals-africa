...
// import { prettyAppointmentTime, prettyPatientDateOfBirth } from "./date";
// import { firstAvailableThirtyMinutes } from "./getDoctorAvailability";
...
//       const nextOfferedTimes: AppointmentOfferedTime[] = [
//         offeredTime,
...
//       assert(patientMessage.appointment_offered_times[0].scheduled);
//       return `Thanks ${
