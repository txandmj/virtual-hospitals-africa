import { HealthWorkerOrganization, RenderedEmployeeWithPresenceAndSeniority, RenderedLicence, RenderedManageTaskToBeDone, TasksDividedByPermission } from '../types.ts'
