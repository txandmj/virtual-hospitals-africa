...
export function isNurseRegistrationStep(step: string | null): step is AddPatientStep {
    if (step === null) {
        return false
    }
...
export function useNurseRegistrationSteps(props: PageProps) {
    ...
    const currentStep = isNurseRegistrationStep(stepQuery) ? stepQuery : NurseRegistrationStepNames[0]
