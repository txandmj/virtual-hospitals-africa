...
export default function NursePersonalForm() {
    return (
        <>
            ...
            <FormRow>
                <TextInput name='national_id' required placeholder='12345678A12' pattern='^[0-9]{8}[a-zA-Z]{1}[0-9]{2}$' label='National ID Number'/>
            </FormRow>
            <FormRow>
                <TextInput name='email' type='email' required label='Email'/>
                <PhoneNumberInput name='mobile_number' required label='Mobile Phone Number'/>
            </FormRow>
            <hr className='my-2' />
