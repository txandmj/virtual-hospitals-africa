    ...
    >
      <Container>
        ...
        <p className='my-t text-lg tracking-tight text-slate-700'>
          Get peace of mind knowing you have instant access to your doctor’s office and global system of virtual hospitals anywhere you are.
        </p>
        <p className='mt-4'>
          <ArrowLink
        ...
        features={[
          {
            ...
            description: 'Speak with your doctor’s office from your mobile device or get immediate answers from our worldwide network of health professionals.',
            image: '/images/demos/talk_with_professional.png',
          },
          {
            title: 'Check your health status',
            description: 'With our WhatsApp chatbot, patients have instant access to their medical records, specialist reports, and lab results.',
            image: '/images/demos/health_status.png',
          },
          {
            title: 'Fill prescriptions automatically',
            description: 'New medications can be sent to your preferred pharmacist. Refill prescriptions with one click from your mobile device.',
            image: '/images/demos/automatic_prescriptions.png',
          },
          {
            title: 'Follow health plan',
            description: 'Receive regular reminders to stay on top of your health and fitness.',
